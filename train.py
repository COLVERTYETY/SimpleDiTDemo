...
if __name__ == "__main__":
    ...
    CIFAR = args.cifar
    save_name = "cifar" if CIFAR else "mnist"
    if CIFAR:
        dataset_name = "cifar"
        ...
        channels = 1
        model = DiT_Llama(
            channels, 32, dim=64, n_layers=3, n_heads=2, num_classes=10
        ).to(device)
    ...
    for epoch in range(100):
        ...
        # save the model
        torch.save(model.state_dict(), f"models/mrf{save_name}_{epoch}.pt")
